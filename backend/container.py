...
class Container(containers.DeclarativeContainer):
    ...
    config_service: providers.Singleton[ConfigService] = providers.Singleton(ConfigService)
    ...
    context_service: providers.Singleton[ContextService] = providers.Singleton(ContextService)
